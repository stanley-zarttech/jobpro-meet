...
/**
 * The react-native side of Joble Meet's {@link ConnectionService}. Exposes
 * the Java Script API.
 *
 * @author Pawel Domas
 */
...
class RNConnectionService extends ReactContextBaseJavaModule {
     ...
     *
     * @param callUUID - unique call identifier assigned by Joble Meet to
     *        a conference call.
     * @param handle - a call handle which by default is Joble Meet room's URL.
