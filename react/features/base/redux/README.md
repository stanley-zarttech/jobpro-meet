Joble Meet - redux state persistence
====================================
Joble Meet has a persistence layer that persists specific subtrees of the redux
...
When it's done, Joble Meet will automatically persist these subtrees and
