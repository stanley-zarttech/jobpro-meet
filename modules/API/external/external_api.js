...
export default class JitsiMeetExternalAPI extends EventEmitter {
    /**
     * Constructs new API instance. Creates iframe and loads Joble Meet in it.
     *
     * @param {string} domain - The domain name of the server that hosts the
     * conference.
    ...
    /**
     * Getter for the large video element in Joble Meet.
     *
    ...
    /**
     * Getter for the prejoin video element in Joble Meet.
     *
    ...
    /**
     * Getter for participant specific video element in Joble Meet.
     *
     ...
     * {@code readyToClose} - all hangup operations are completed and Joble Meet
    ...
    /**
     * Removes the listeners and removes the Joble Meet frame.
     *
     * @returns {void}
     */
    dispose() {
    ...
    /**
     * Returns the iframe that loads Joble Meet.
     *
     ...
     * Only applies to certain Joble Meet deploys.
