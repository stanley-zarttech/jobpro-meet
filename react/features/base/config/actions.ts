...
/**
 * Signals that the configuration (commonly known in Joble Meet as config.js)
...
/**
 * Signals that a configuration (commonly known in Joble Meet as config.js)
...
/**
 * Stores a specific Joble Meet config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The Joble Meet config.js to store.
 * @returns {Function}
 */
